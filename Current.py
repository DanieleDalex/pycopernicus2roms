...
if __name__ == '__main__':
    ...
    u_destination = nc_destination['u'][:]
    u_destination = u_destination[:, :, :, time]
    u_destination[:] = out_final_u[:]

    v_destination = nc_destination['v'][:]
    v_destination = v_destination[:, :, :, time]
    v_destination[:] = out_final_v[:]
